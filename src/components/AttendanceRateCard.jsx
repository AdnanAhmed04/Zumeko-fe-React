  ...
  return (
    <div className="bg-white rounded-lg p-8 md:p-4 border border-gray-200 shadow w-full md:w-[25%]">
      <div className="flex gap-5 md:gap-3 items-center">
        <h3 className="text-gray-700 font-bold text-lg md:text-base">Attendance Rate</h3>
        <span className="text-gray-400 text-xl md:text-sm">
      ...
      <div className="text-4xl md:text-3xl font-bold mt-5 md:mt-2">98.6%</div>
      <p className="text-gray-600 text-md md:text-sm mt-4 md:mt-1">This week (Target: 95%)</p>
      <p className="text-green-600 text-md md:text-sm mt-4 md:mt-1 flex items-center gap-3 md:gap-1 font-bold">
