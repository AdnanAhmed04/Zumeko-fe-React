  ...
  return (
    <div className="bg-white rounded-lg p-8 md:p-4 border border-gray-200 shadow w-full md:w-[25%]">
      <div className="flex gap-5 md:gap-3 items-center">
        <h3 className="text-gray-700 font-bold text-2xl md:text-base">Attendance Rate</h3>
      ...
      <div className="text-6xl md:text-3xl font-bold mt-5 md:mt-2">98.6%</div>
      <p className="text-gray-600 text-2xl md:text-sm mt-4 md:mt-1">This week (Target: 95%)</p>
