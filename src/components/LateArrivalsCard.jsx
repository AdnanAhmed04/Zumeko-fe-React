  ...
  return (
    <div className="bg-yellow-50 rounded-lg p-8 md:p-4 border border-yellow-200 shadow w-full md:w-[25%]">
      <div className="flex gap-5 md:gap-3 items-center">
        <h3 className="text-gray-700 font-bold text-2xl md:text-base">
          Late Arrivals
        </h3>
      ...
      <div className="text-6xl md:text-3xl font-extrabold mt-5 md:mt-2">33</div>

      <p className="text-gray-600 text-2xl md:text-sm mt-4 md:mt-1">
        This week (+12% from last week)
      </p>

      <p className="text-red-600 text-2xl md:text-sm mt-4 md:mt-1 flex items-center gap-3 md:gap-1 font-bold">
        <svg
          xmlns="http://www.w3.org/2000/svg"
